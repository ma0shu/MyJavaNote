...
public class DynamicProxy {
    public static void main(String[] args) {
        // 普通学生类
        Studenttt ordinaryStudents = new OrdinaryStudents();
        ...
        Studenttt sonOfDistrict = (Studenttt) Proxy.newProxyInstance(ordinaryStudents.getClass().getClassLoader(), ordinaryStudents.getClass().getInterfaces(), handler);
        sonOfDistrict.eat();
        sonOfDistrict.write();
 ...
 * 普通学生，能跑，能吃，能写作文。
 */
class OrdinaryStudents implements Studenttt {
    @Override
    public void eat() {
